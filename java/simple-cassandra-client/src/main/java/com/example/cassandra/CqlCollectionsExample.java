...
public class CqlCollectionsExample extends SimpleClient {
	...
	private final String CREATE_USERS_TABLE = "CREATE TABLE social.users (" +
			"user text PRIMARY KEY, " +
			"tasks list<text>, " + 
			"tags set<text>, " +
			"posts map<timestamp, text>" +
			");";
	private final String INSERT_USERS_DATA_SIMPLE = "INSERT INTO social.users (user, tasks, tags, posts) VALUES ";
	private final String INSERT_USERS_DATA_PREPARED = INSERT_USERS_DATA_SIMPLE +
			"(?, ?, ?, ?);";
	private final String SELECT_ALL_USERS = "SELECT * FROM social.users;";
	...
	public void createSchema() {
      ...
      System.out.println("social keyspace and schema created.");
	}
